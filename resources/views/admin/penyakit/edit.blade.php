...
<body>
    ...
    @enderror
      <form method="POST" action="{{route('admin_edit_penyakit', $penyakit->id)}}">
      {{ csrf_field() }}

        <div class="form-group row">
          <label for="inputNama3" class="col-sm-2 col-form-label">Nama</label>
          <div class="col-sm-10">
            <input type="text" name="nama" class="form-control" id="inputNama3" placeholder="Nama" value="{{ $penyakit->nama }}">
          </div>
        </div>
